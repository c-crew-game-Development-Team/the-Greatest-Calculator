...
public class RankingNumberBarScript : MonoBehaviour
{
    ...
    public void nummaker()
    {
        ...
        if (i == 0)
        {
            ...
            spriteJ.sprite = spritesN[punch.GetComponent<RankingPunchScript>().attack[0]];
        ...
        else if (i == 1)
        {
            ...
            spriteK.sprite = spritesM[punch.GetComponent<RankingPunchScript>().attack[1] - 1];
        ...
        else if (i == 2)
        {
            ...
            spriteL.sprite = spritesN[punch.GetComponent<RankingPunchScript>().attack[2]];
    ...
    void Stop1() //����� ������ �ٷ� ����
    {
        ...
        int a = punch.GetComponent<RankingPunchScript>().result % 10; //���� �ڸ�
        int b = (punch.GetComponent<RankingPunchScript>().result / 10) % 10; //���� �ڸ�
        int c = punch.GetComponent<RankingPunchScript>().result / 100; //���� �ڸ�
        ...
        if (punch.GetComponent<RankingPunchScript>().result > 99 && punch.GetComponent<RankingPunchScript>().result <= 999)
        {
        ...
        else if (punch.GetComponent<RankingPunchScript>().result > 9 && punch.GetComponent<RankingPunchScript>().result <= 99)
        {
        ...
        else if (punch.GetComponent<RankingPunchScript>().result >= 0 && punch.GetComponent<RankingPunchScript>().result <= 9)
        {
